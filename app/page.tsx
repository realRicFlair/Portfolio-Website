      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            Welcome to your <strong>DOOM</strong>.<br /> This is an in-progress portfolio brought to you by {' '}
            <a href="https://nextjs.org/learn/" className="text-gray-800 bold">
              <strong>Roro Corp</strong>
            </a>
          </p>
          <p className={`${lusitana.className} text-cyan-800 md:text-3xl md:leading-normal`}> Gutturkoo </p>
          <Link
            href="/dashboard"
